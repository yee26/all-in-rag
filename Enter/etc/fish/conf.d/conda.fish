set -gx CONDA_EXE "/workspaces/all-in-rag/Enter/bin/conda";
set -gx _CONDA_EXE "/workspaces/all-in-rag/Enter/bin/conda";
set -e _CE_M || true;
set -e _CE_CONDA || true;
set -gx CONDA_PYTHON_EXE "/workspaces/all-in-rag/Enter/bin/python";
set -gx _CONDA_ROOT "/workspaces/all-in-rag/Enter";

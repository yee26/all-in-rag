export CONDA_EXE='/workspaces/all-in-rag/Enter/bin/conda'
export _CONDA_EXE='/workspaces/all-in-rag/Enter/bin/conda'
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE='/workspaces/all-in-rag/Enter/bin/python'
export _CONDA_ROOT='/workspaces/all-in-rag/Enter'
